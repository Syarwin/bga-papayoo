...
<div id="hand_remain"></div>

<script type="text/javascript">
var jstpl_playertables = '<div id="playertables" style="width: ${w}px; height: ${h}px;"></div>';

var jstpl_playertable = `
<div class="playertable whiteblock" style="width:\${w}px; height:\${h}px; left: \${x}px; bottom: \${y}px;">
...
var jstpl_dicevalue = `<div id="dicevalue" class="whiteblock" style="left:\${x}px; bottom:\${y}px;">
  <div class="camera">
    <div class="dice" data-show="1">
      <div class="face1"></div>
      <div class="face2"></div>
      <div class="face3"></div>
      <div class="face4"></div>
